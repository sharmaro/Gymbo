...
extension StartSessionTVC {
    ...
    private func getExerciseHeaderTVCell(for indexPath: IndexPath,
    ...
    private func getExerciseDetailTVCell(for indexPath: IndexPath,
...
extension StartSessionTVC {
    ...
    override func tableView(_ tableView: UITableView,
        ...
        case 0: // Exercise header cell
            cell = getExerciseHeaderTVCell(for: indexPath, session: session)
        ...
        default: // Exercise detail cell
            cell = getExerciseDetailTVCell(for: indexPath, session: session)
        }
        return cell
    }
...
extension StartSessionTVC {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        guard let exerciseDetailCell = tableView.cellForRow(
            at: indexPath) as? ExerciseDetailTVCell else {
            return
        }
...
extension StartSessionTVC: StartSessionButtonDelegate {
    func addExercise() {
        modallyPresenting = .exercisesTVC
...
extension StartSessionTVC: RestTimerDelegate {
